...
//-----------------------------------------------------------------------------
char * CleanFileName(char * OriginalFileName,char * CleanFileName) {
...
CleanFileName[0] == CleanFileName[strlen(CleanFileName)-1]) {
        strcpy(CleanFileName,&CleanFileName[1]);
        CleanFileName[strlen(CleanFileName)-1] = '\0';
    }
...
PRINTFILE OpenPrintFile(char * OriginalFileName) {
    ...
    CleanFileName(OriginalFileName,FileName);
