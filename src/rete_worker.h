...
rete_worker* init_rete_worker(const rete_net*, unsigned int, substitution_store_mt *, substitution_store_array *, rule_queue_single *, rete_worker_queue *, const constants*);
